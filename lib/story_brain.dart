...
class StoryBrain {
  ...
  void nextStory(int seleted) {
    if (seleted == 1 && _storyNumber == 0) {
      _storyNumber = 2;
    } else if (seleted == 2 && _storyNumber == 0) {
      _storyNumber = 1;
    } else if (seleted == 1 && _storyNumber == 2) {
      _storyNumber = 5;
    } else if (seleted == 2 && _storyNumber == 2) {
      _storyNumber = 4;
    } else if (seleted == 1 && _storyNumber == 1) {
      _storyNumber = 2;
    } else if (seleted == 2 && _storyNumber == 1) {
      _storyNumber = 3;
    } else {
      restart();
    }
